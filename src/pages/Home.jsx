  ...
  return (
    ...
    <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md text-center">
      ...
      <div className="flex justify-around mt-4">
        <span onClick={()=>navigate('/')} className="text-indigo-600 hover:underline">Login</span>
        <span onClick={handleLogout} className="text-indigo-600 hover:underline">Logout</span>
      </div>
    </div>
  </div>
  )
